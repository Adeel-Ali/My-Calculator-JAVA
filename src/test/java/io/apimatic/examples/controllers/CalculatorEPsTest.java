...
import io.apimatic.examples.controllers.CalculatorEPs;

import com.fasterxml.jackson.core.type.TypeReference;

public class CalculatorEPsTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static CalculatorEPs controller;
    ...
    public static void setUpClass() {
        controller = getClient().getCalculatorEPs();
    }
